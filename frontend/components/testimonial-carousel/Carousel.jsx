...
export default function TestimonialCarousel() {
  return (
    <div
      className="bg-gry-200 mx-auto rounded-2xl"
          ...
          >
            <blockquote className="rounded-xl bg-white p-6 shadow-sm sm:p-8">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <div className="flex flex-col justify-center gap-0.5 text-yellow-500">
                    <p className="mt-0.5 font-clash text-lg font-medium text-gray-900">
                      Paul Starr
                    </p>
              ...
              <p className="mt-4 font-geist text-gray-700">
